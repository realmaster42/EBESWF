package
{
   ...
   public class _WebClient_Styles
   {
      ...
      private static var _embed_css_Assets_swf__1791391815_mx_skins_cursor_BusyCursor_955145799:Class = _class_embed_css_Assets_swf__1791391815_mx_skins_cursor_BusyCursor_955145799;
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         if(style.defaultFactory == null)
         {
            style.defaultFactory = function():void
            {
               ...
               this.busyCursorBackground = _embed_css_Assets_swf__1791391815_mx_skins_cursor_BusyCursor_955145799;
            };
         }
         if(mergedStyle != null && (mergedStyle.defaultFactory == null || ObjectUtil.compare(new style.defaultFactory(),new mergedStyle.defaultFactory())))
         {
