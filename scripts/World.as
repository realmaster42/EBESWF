         ...
         while(_loc12_ < _loc10_)
         {
            ...
            for(; _loc13_ < _loc11_; _loc13_++)
            {
               ...
               else
               {
                  ...
                  if(type != 0)
                  {
                     if(ItemId.isBlockRotateable(type) && type != ItemId.HALLOWEEN_2016_EYES && !ItemId.isNonRotatableHalfBlock(type))
                     {
      ...
      public function drawDialogs(param1:BitmapData, param2:int, param3:int) : void
      {
         ...
         while(_loc8_ < _loc6_)
         {
            ...
            for(; _loc9_ < _loc7_; _loc9_++)
            {
               ...
               {
                  case ItemId.WORLD_PORTAL:
                     _loc12_ = new Point(this.player.x,this.player.y);
                     _loc13_ = new Point(_loc9_ * 16,_loc8_ * 16);
               ...
               if(Global.getPlacer)
               {
                  _loc12_ = new Point(Bl.mouseX - param2 - 16,Bl.mouseY - param3 - 16);
                  _loc13_ = new Point(_loc9_ * 16,_loc8_ * 16);
