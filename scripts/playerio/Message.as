   ...
   public class Message
   {
      ...
      public function toString() : String
      {
         ...
         while(_loc3_ < content.length)
         {
            ...
            if(_loc4_ === undefined)
            {
               _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tundefined\t\t" + _loc4_ + "\n");
            }
            else if(_loc4_ is String)
            {
               _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tString\t\t" + _loc4_ + "\n");
            }
            else if(_loc4_ is Boolean)
            {
               _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tBoolean\t\t" + _loc4_ + "\n");
            }
            else if(_loc4_ is ByteArray)
            {
               _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tByteArray\tLength:" + _loc4_.length + "\n");
            }
            else
            {
               ...
               {
                  _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tint\t\t\t" + _loc4_ + "\n");
               }
               else
               {
                  _loc2_ = new ByteArray();
                  ...
                  {
                     _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tuint\t\t" + _loc4_ + "\n");
                  }
                  else
                  {
                     _loc2_ = new ByteArray();
                     ...
                     {
                        _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tFloat\t\t" + _loc4_ + "\n");
                     }
                     else
                     {
                        _loc1_ = _loc1_ + ("\t\t\t" + _loc3_ + "\tDouble\t\t" + _loc4_ + "\n");
                     }
                  }
               }
            }
