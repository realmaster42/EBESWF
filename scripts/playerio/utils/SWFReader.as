   ...
   public class SWFReader
   {
      ...
      public function parse(param1:ByteArray) : void
      {
         ...
         try
         {
            ...
            bytes.position = 0;
            _loc4_ = uint(bytes.readUnsignedByte());
            _loc2_ = uint(bytes.readUnsignedByte());
            _loc3_ = uint(bytes.readUnsignedByte());
      ...
      private function readBits(param1:uint, param2:Boolean = false) : Number
      {
         ...
         if(param1 <= _loc4_)
         {
            ...
            _loc6_ = Number(currentByte >> _loc4_ - param1 & _loc7_);
            if(param1 == _loc4_)
            {
               nextBitByte();
            }
         ...
         else
         {
            ...
            nextBitByte();
            _loc6_ = Number(_loc5_ << _loc3_ | readBits(_loc3_));
         }
      ...
      private function readTag() : Boolean
      {
         ...
         var _loc3_:int = bytes.readUnsignedShort();
         currentTag = _loc3_ >> 6;
         var _loc2_:uint = _loc3_ & 63;
         if(_loc2_ == 63)
         {
