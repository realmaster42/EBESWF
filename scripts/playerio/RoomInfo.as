package playerio
{
   public class RoomInfo
   {
      ...
      public function toString() : String
      {
         ...
         _loc1_ = _loc1_ + ("id:\t\t\t\t" + id + "\n");
         _loc1_ = _loc1_ + ("roomType:\t\t" + roomType + "\n");
         _loc1_ = _loc1_ + ("onlineUsers:\t" + onlineUsers + "\n");
         _loc1_ = _loc1_ + "initData:\t\tId\t\t\t\t\t\tValue\n";
         _loc1_ = _loc1_ + "\t\t\t\t-------------------------------------------\n";
         var _loc4_:int = 0;
         var _loc3_:* = initData;
         for(var _loc2_ in initData)
         {
            _loc1_ = _loc1_ + ("\t\t\t\t" + _loc2_ + "\t\t\t\t\t".substring(_loc2_.length / 4) + "\t" + initData[_loc2_] + "\n");
         }
         return _loc1_;
      }
   }
