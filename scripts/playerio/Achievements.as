package playerio
{
   ...
   public class Achievements extends playerio.generated.Achievements
   {
      ...
      public function progressSet(param1:String, param2:int, param3:Function, param4:Function) : void
      {
         ...
         callback = param3;
         errorHandler = param4;
         _achievementsProgressSet(achievementId,progress,function(param1:Achievement, param2:Boolean):void
         {
      ...
      {
         achievementId = param1;
         progressDelta = param2;
         callback = param3;
         errorHandler = param4;
         _achievementsProgressAdd(achievementId,progressDelta,function(param1:Achievement, param2:Boolean):void
         {
            processResults(param1,param2,callback);
         },errorHandler);
      }
      ...
      public function progressMax(param1:String, param2:int, param3:Function, param4:Function) : void
      {
         ...
         callback = param3;
         errorHandler = param4;
         _achievementsProgressMax(achievementId,progress,function(param1:Achievement, param2:Boolean):void
         {
            processResults(param1,param2,callback);
         },errorHandler);
      }
      ...
      public function progressComplete(param1:String, param2:Function, param3:Function) : void
      {
         ...
         callback = param2;
         errorHandler = param3;
         _achievementsProgressComplete(achievementId,function(param1:Achievement, param2:Boolean):void
         {
            processResults(param1,param2,callback);
         },errorHandler);
      }
      ...
      private function processResults(param1:playerio.generated.messages.Achievement, param2:Boolean, param3:Function) : void
      {
         ...
         if(_myAchievements != null)
         {
            ...
            if(_loc4_ == null)
            {
               _loc4_ = new playerio.Achievement();
               _loc4_._internal_initialize(param1);
