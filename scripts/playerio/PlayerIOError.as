package playerio
{
   public class PlayerIOError extends Error
   {
      ...
      public static const YahooNotAvailable:PlayerIOError = new PlayerIOError("The Yahoo features are only avaliable when authenticated to PlayerIO using Yahoo authentication. Authentication methods are managed in the connections setting of your game in the admin panel on PlayerIO.",200);
      
      public static const YahooNotLoaded:PlayerIOError = new PlayerIOError("Cannot access profile, friends, ignored before Yahoo has been loaded. Please refresh Yahoo first.",201);
