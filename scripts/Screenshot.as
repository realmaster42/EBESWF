package
{
   ...
   public class Screenshot
   {
      ...
      public static function SavePNGWithMinimap(param1:MouseEvent) : void
      {
         var _loc3_:ByteArray = null;
         var _loc2_:FileReference = new FileReference();
         if(param1.buttonDown)
         {
            (Global.base.state as PlayState).world.drawFull();
            _loc3_ = PNGEncoder.encode((Global.base.state as PlayState).minimap.getBitmapData());
            _loc2_.save(_loc3_,Global.roomid + "-minimap.png");
         }
      }
   }
}
