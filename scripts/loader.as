package
{
   ...
   public class loader extends MovieClip
   {
      ...
      public function loader()
      {
         ...
         {
            navigateToURL(new URLRequest(Config.url_help_page),"_blank");
         };
         ...
         {
            navigateToURL(new URLRequest(Config.url_terms_page),"_blank");
         };
         showFAQ = function(param1:ContextMenuEvent):void
         {
            navigateToURL(new URLRequest(Config.url_faq),"_blank");
         };
         showForums = function(param1:ContextMenuEvent):void
         {
            navigateToURL(new URLRequest(Config.url_forums),"_blank");
         };
         ...
         var faq_cm:ContextMenuItem = new ContextMenuItem("Frequently Asked Questions");
         ...
         faq_cm.addEventListener(ContextMenuEvent.MENU_ITEM_SELECT,showFAQ);
